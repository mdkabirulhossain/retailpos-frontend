      ...
      <div className="mx-auto max-w-7xl px-6 py-12">
        <div className="flex flex-col md:flex-row md:justify-between gap-12">
          ...
          <div className="flex flex-col gap-6">
            <h2 className="text-xl font-bold text-neutral-800">Brillance</h2>
            <p className="text-sm italic text-neutral-600">Coding made effortless</p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8 md:gap-16">
            ...
            {/* Resources */}
            <div className="flex flex-col gap-4">
              <h3 className="text-sm font-medium text-neutral-500">Resources</h3>
              <nav className="flex flex-col gap-3">
                <Link href="#" className="text-sm text-neutral-700 hover:text-neutral-900 transition-colors">
                  Terms of use
                </Link>
