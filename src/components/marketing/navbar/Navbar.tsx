...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-6 left-0 right-0 z-50 flex flex-col items-center px-4 pointer-events-none">
      <div className="flex items-center justify-between w-full max-w-4xl h-14 px-6 bg-white/70 backdrop-blur-md border border-gray-200/50 rounded-full shadow-sm pointer-events-auto">
